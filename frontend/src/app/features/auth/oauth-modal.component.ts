      ...
      <div class="text-center">
        @if (isLoading()) {
          ...
          <div class="py-8">
            ...
            <p class="text-gray-600 mb-2">Connecting to Twitch...</p>
            <p class="text-sm text-gray-500">Please complete authentication in the popup window</p>
          </div>
        } @else if (error()) {
          <!-- Error State -->
          <div class="py-8">
          ...
          <div class="py-8">
            ...
            <h3 class="text-lg font-medium text-gray-900 mb-2">Connect your Twitch Account</h3>
            <p class="text-gray-600 mb-6">Sign in with Twitch to join games and chat with other players</p>
            
            <div class="space-y-3">
              <alias-button (click)="startAuth()" class="w-full">
              ...
              <alias-button variant="ghost" (click)="close()" class="w-full">
                Cancel
              </alias-button>
            </div>
